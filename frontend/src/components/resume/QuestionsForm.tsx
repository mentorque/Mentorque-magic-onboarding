...
export function QuestionsForm({ questions, parsedResume, onRevamped, apiBaseUrl = '' }: QuestionsFormProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center space-y-12">
      ...
      <div className="w-full max-w-2xl relative min-h-[500px] flex flex-col">
        {/* Progress bar */}
        ...
        <div className="relative pt-8 pb-32">
          ...
          <div className="absolute -left-16 top-36 hidden xl:block">
            <motion.button
              ...
              className={cn(
                ...
                (currentIndex === 0 || loading) && "opacity-0 pointer-events-none"
              )}
          ...
          <div className="absolute -right-16 top-36 hidden xl:block">
            <motion.button
              ...
              className={cn(
                "p-3 transition-all duration-300 text-foreground/40 hover:text-foreground",
                (currentIndex === questions.length - 1 || loading) && "opacity-0 pointer-events-none"
              )}
              whileHover={{ x: 5, scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
            >
              ...
              {currentQuestion.questionType === 'mcq' && currentQuestion.options ? (
                    ...
                    {currentQuestion.options.map((option) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileHover={{ scale: 1.01, borderColor: "oklch(from var(--foreground) l c h / 0.2)" }}
                          whileTap={{ scale: 0.99 }}
                          className={cn(
                ...
                <div className="glass-textarea-wrap w-full">
                  <div className="glass-textarea p-6 flex flex-col gap-6 w-full">
                    <p className="text-foreground text-xl font-medium leading-tight w-full">{currentQuestion.question}</p>
